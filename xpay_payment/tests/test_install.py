...
class TestInstall(TransactionCase):
    ...
    def test_transaction_hooks_match_the_base_signature(self):
        ...
        expectations = {
            "_handle_notification_data": ["self", "provider_code", "notification_data"],
            "_get_tx_from_notification_data": ["self", "provider_code", "notification_data"],
            "_process_notification_data": ["self", "notification_data"],
            "_send_refund_request": ["self", "amount_to_refund"],
